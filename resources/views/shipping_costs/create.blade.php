<x-layouts.main-content title="Nuevo Tramo de Envío">
  <form method="POST" action="{{ route('shipping_costs.store') }}" class="max-w-sm space-y-4">
    @csrf
    ...
    <button type="submit" class="btn">Crear tramo</button>
  </form>
