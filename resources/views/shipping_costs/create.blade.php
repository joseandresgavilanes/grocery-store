<x-layouts.main-content title="New Shipping Bracket">
    <div class="max-w-3xl mx-auto mt-10 bg-white dark:bg-gray-900 shadow-md rounded-lg p-6 space-y-6">
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100">New Shipping Bracket</h2>
        ...
        <form method="POST" action="{{ route('shipping_costs.store') }}" class="space-y-6">
            @csrf
